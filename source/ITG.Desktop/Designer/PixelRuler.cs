...
// Taken from https://wpfruler.codeplex.com/
/* THINGS TO DO TO THIS:
 * 1) Change the weird transform thing so you can use the Orientation property = Horizontal or Vertical
 * 2) And then it would use Alignment = Top, Bottom, Left, Right (or could dock it, whatever)
 * 3) Version without numbers so it's thinner?
 * 4) Version that tracks the mouse cursor with a moving dashed line over it
 */
