...
{
    public static integer ColorToAhlta(Color c)
    {
/*
 ...
 */
    ...
    public static integer ColorToArgb(Color c)
    {
    ...
    public static string ColorToHex(Color c, Boolean includeAlpha)
    {
        /*
    ...
    public static integer ArgbToAhlta(integer argb)
    { 
    
    }

    public static Color ArgbToColor(integer argb)
    {

    }

    public static string ArgbToHex(integer argb, boolean includeAlpha)
    {
    ...
    */
    ...
    public static integer HexToAhlta(string hex, boolean hasAlpha)
    {

    }

    public static integer HexToArgb(string hex, boolean hasAlpha)
    {

    }

    public static Color HexToColor(string hex, boolean hasAlpha)
    {
    ...
    */
    ...
    public static integer AhltaToArgb(integer ahlta)
    {

    }

    public static Color AhltaToColor(integer ahlta)
    {

    }

    public static string AhltaToHex(integer ahlta, boolean includeAlpha)
    {
