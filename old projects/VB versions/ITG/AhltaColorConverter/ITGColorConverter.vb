Namespace ITG.Utility
    ...
    Class ITGColorConverter
        ...
        Public Shared Function ConvertColorToAhlta(ByVal c As Color) As Integer
        ...
        Public Shared Function ConvertColorToArgb(ByVal c As Color) As Integer
            ' Acts as a wrapper for the built-in function
            Debug.WriteLine("Function ConvertColorToArgb(Color) returns: " & c.ToArgb())
            Return c.ToArgb()
        End Function 'done

        Public Shared Function ConvertColorToHex(ByVal c As Color, ByVal IncludeAlpha As Boolean) As String
